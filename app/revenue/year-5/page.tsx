...
const revenueRows: RevenueRow[] = [
  { service: "Company Formation", clients: 14, unitUsd: 2500, newRevenue: 35000, renewals: 50, renewalRevenue: 93750, total: 128750 },
  { service: "Full Structure", clients: 3, unitUsd: 29700, newRevenue: 89100, renewals: 9, renewalRevenue: 200475, total: 289575 },
...
const TOTAL_REVENUE_USD = 461825;
const TOTAL_REVENUE_INR = 42026075;
const TOTAL_CLIENTS = revenueRows.reduce((sum, row) => sum + row.clients, 0);
const GROWTH_VS_YEAR4 = "25.24%";
