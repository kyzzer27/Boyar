...
const expenditureButtons: ExpenditureButton[] = [
	...
	{ id: "category-wise-spend", label: "Category-Wise Spend Allocation" },
	{
		...
		description:
			"Planned vs actual tracking, variance analytics, and exception flags (shown in dedicated page; example only until live).",
	},
		...
		<div className="fixed inset-0 z-50 bg-black">
			...
			>
				<motion.div
					...
					className="relative w-full max-w-5xl max-h-[85vh] overflow-y-auto bg-black/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-4 sm:p-8 md:p-10"
					style={{
						boxShadow:
				...
				>
						...
						{expenditureButtons.map((button, index) => {
							...
							return (
								<motion.button
									...
									onMouseEnter={() => handleCardMouseEnter(button.id)}
								...
								>
									...
									<div className="relative z-10">
										<h3
											className="text-white font-semibold text-base sm:text-lg md:text-xl mb-1"
											style={{
												fontFamily:
													"Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif",
												transition: "color 0.3s ease",
												color: isHovered ? "#E0E7FF" : "#FFFFFF",
											}}
										>
											{button.label}
										</h3>
					...
					>
						{(() => {
							const isDisclaimerHovered = hoveredButton === "disclaimer";
							return (
								<motion.button
									...
									onMouseEnter={() => handleCardMouseEnter("disclaimer")}
									onMouseLeave={handleCardMouseLeave}
									...
									>
										<rect
											...
											style={{
												width: "calc(100% - 2px)",
												height: "calc(100% - 2px)",
												strokeDashoffset: isDisclaimerHovered ? 0 : 100,
											}}
										/>
									</svg>
										...
										<h3
											...
											style={{
												fontFamily:
													"Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif",
												transition: "color 0.3s ease",
												color: isDisclaimerHovered ? "#E0E7FF" : "#FFFFFF",
											}}
										>
											Disclaimer
										</h3>
