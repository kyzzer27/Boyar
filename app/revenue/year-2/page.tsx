...
const revenueRows: RevenueRow[] = [
  { service: "Company Formation", clients: 14, unitUsd: 2500, newRevenue: 35000, renewals: 8, renewalRevenue: 15000, total: 50000 },
  { service: "Full Structure", clients: 2, unitUsd: 29700, newRevenue: 59400, renewals: 2, renewalRevenue: 44550, total: 103950 },
  ...
  { service: "Corporate Services", clients: 6, unitUsd: 3500, newRevenue: 21000, renewals: 0, renewalRevenue: 0, total: 21000 },
];

const TOTAL_REVENUE_USD = 193950;
const TOTAL_REVENUE_INR = 17663450;
const TOTAL_CLIENTS = revenueRows.reduce((sum, row) => sum + row.clients, 0);
const GROWTH_VS_YEAR1 = "79.67%";
