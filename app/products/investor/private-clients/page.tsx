								...
								<motion.button
									...
									onClick={() => {
										const routes: Record<string, string> = {
											Trust: "/products/investor/trust",
											Foundations: "/products/investor/foundations",
											"Family Office Solutions":
												"/products/investor/family-office",
											"Fiduciary & Directorship":
												"/products/investor/fiduciary-directorship",
											"Insurance Solutions":
												"/products/investor/insurance-solutions",
											"Philanthropy Solutions":
												"/products/investor/philanthropy-solutions",
											"Estate Planning": "/products/investor/estate-planning",
											"Corporate Structuring":
												"/products/investor/corporate-structuring",
											"Custodian Services":
												"/products/investor/custodian-services",
											"Succession Management":
												"/products/investor/succession-management",
											"Marine Services": "/products/investor/marine-services",
											"Citizenship & Stewardship": "/products/investor/citizenship-stewardship",
										};
								...
								>
									...
									<div className='space-y-3'>
										...
										<p className='text-sm text-gray-400 leading-relaxed'>
											Tailored delivery with dedicated governance and reporting.
										</p>
									</div>
