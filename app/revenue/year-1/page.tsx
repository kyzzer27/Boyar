          ...
          <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-4 py-5 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <h1 className="text-2xl font-semibold text-white" style={{ fontFamily: "var(--font-benzin)" }}>
                Revenue Stack · FY2026
              </h1>
            </div>
            <div className="text-right text-xs text-white/60">
              <p>Total Clients: {TOTAL_CLIENTS}</p>
              <p>Growth vs Prior: {GROWTH_VS_PRIOR}</p>
            </div>
          </div>
        </header>
        ...
        <main className="relative z-10 mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
          <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { label: "Renewals", value: "0 (Year 1 focus)" },
            ].map((card) => (
              <motion.div
                key={card.label}
          ...
          <section className="mt-10 rounded-3xl border border-white/10 bg-black/60 p-6 shadow-2xl">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="rounded-full border border-white/20 bg-white/5 px-4 py-2 text-xs text-white/70">
                All values in USD unless specified.
              </div>
            </div>
            <div className="mt-6 overflow-x-auto">
              <table className="w-full text-sm text-white/80">
                ...
                <tbody>
                  ...
                  <tr className="border-t border-white/10 text-white font-semibold">
                    <td className="px-4 py-3">Growth % vs prior year</td>
                    <td className="px-4 py-3 text-right">—</td>
                    <td className="px-4 py-3 text-right">—</td>
                    <td className="px-4 py-3 text-right">—</td>
                    <td className="px-4 py-3 text-right">—</td>
                    <td className="px-4 py-3 text-right">—</td>
                    <td className="px-4 py-3 text-right">{GROWTH_VS_PRIOR}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <h3 className="text-lg font-semibold text-white" style={{ fontFamily: "var(--font-benzin)" }}>
                  How Year 1 revenue is constructed
                </h3>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  body: "High-ticket mandates (Full Structure + Corporate) account for 68% of revenue, validating the top-of-funnel targeting hypothesis.",
                },
                {
                  title: "Cash efficiency",
                  body: "No renewals are assumed for Year 1; this is a pure net-new revenue stack, ready to compound with subscription/retainer overlays in Year 2.",
                },
                {
                  title: "Currency hedge",
                  body: `All USD values translate to ${inrFormatter(TOTAL_REVENUE_INR)} at prevailing FX, supporting India HQ operational spending.`,
                },
                {
                  title: "Growth placeholder",
                  body: "Growth vs prior year is marked N/A because this is the first modeled year; subsequent cohorts will establish the baseline for YoY reporting.",
                },
              ].map((block) => (
