...
const revenueRows: RevenueRow[] = [
  { service: "Company Formation", clients: 14, unitUsd: 2500, newRevenue: 35000, renewals: 22, renewalRevenue: 41250, total: 76250 },
  { service: "Full Structure", clients: 2, unitUsd: 29700, newRevenue: 59400, renewals: 4, renewalRevenue: 89100, total: 148500 },
...
const TOTAL_REVENUE_USD = 268250;
const TOTAL_REVENUE_INR = 24410750;
const TOTAL_CLIENTS = revenueRows.reduce((sum, row) => sum + row.clients, 0);
const GROWTH_VS_YEAR2 = "38.35%";
