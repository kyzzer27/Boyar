...
interface FebCategory {
  ...
  description: string;
  includes?: string[];
  decreaseReasoning?: string;
}

const FEB_CATEGORIES: FebCategory[] = [
  {
    ...
    color: "#3B82F6",
    description:
      "Core execution stack covering research, CRM, documentation, communication, prospecting, and security.",
    includes: [
      "ChatGPT Business ×2",
      "HubSpot Starter ×2",
      "Canva Pro",
  ...
  },
  {
    ...
    color: "#10B981",
    description:
      "Strategic office presence near corporate hubs to support credibility, meetings, and relationship-building.",
    includes: ["Office rent (cabin near corporate offices)"],
  },
  {
    name: "Device Rental",
    inr: 14000,
    ...
    color: "#8B5CF6",
    description:
      "Laptop rentals for two founders, preserving capital flexibility while maintaining high performance.",
  ...
  },
  {
    ...
    color: "#EF4444",
    description:
      "Studio / hotel environment and camera equipment to produce high-credibility content aligned with boutique positioning.",
  ...
  },
  {
    ...
    color: "#F59E0B",
    description:
      "Performance-tracked paid acquisition across defined channels, aligned with CAC framework and pipeline continuity.",
    includes: ["Paid ads across defined channels"],
    decreaseReasoning:
      "February sits immediately after the year-start planning phase. Decision-makers have moved from strategic intent into execution, making it a period of high responsiveness but selective action. For HNIs, founders, and corporates, this is when discussions initiated in January begin translating into concrete structuring, banking, and advisory conversations. Ad spend is maintained at a moderate level to capture follow-through demand from January planning activity, engage decision-makers who delay action until post-New Year clarity, and build a qualified pipeline ahead of the March fiscal-year-end surge. Spending is intentionally not aggressive, as February prioritises lead quality and conversion readiness over volume. This balance ensures efficient CAC while positioning the firm strongly for the higher-intent months that follow.",
  },
  {
    ...
    color: "#EC4899",
    description:
      "External Social Media Manager / Editor to ensure consistent, high-quality publishing and channel management.",
  ...
  },
  {
    ...
    color: "#14B8A6",
    description:
      "Disciplined contingency buffer for unforeseen but necessary operational requirements, with pre-reported usage.",
  },
];
        ...
        <header className="relative z-10 border-b border-white/10 bg-black/90">
          <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center flex-1">
              ...
              >
                February 2026 — Monthly Expenditure Breakdown
              </h1>
            </div>
            <div className="text-right text-xs text-white/60">
              <p>Exchange Rate: 1 USD = 91 INR</p>
              <p>Nature: Stable operations & execution month</p>
            </div>
          </div>
        </header>
        ...
        <main className="relative z-10 mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 space-y-10">
            ...
            <div className="grid gap-6 md:grid-cols-[1.6fr,1.1fr]">
              <div className="space-y-4 text-sm sm:text-base leading-relaxed text-white/80">
                <p className="text-white/80">
                  February 2026 is a disciplined execution month: no new structural
                  costs, no licensing shocks, and a burn profile fully aligned with
                  the operating model defined at launch. Spend is concentrated on
                  productive levers—technology, infrastructure, content, marketing,
                  and critical talent—without expanding the fixed-cost base.
                </p>
                <p className="text-white/80">
                  The focus is on optimisation and deal execution: refining
                  acquisition funnels, sustaining visibility, progressing client
                  conversations, and maintaining operational readiness across all
                  client-facing and governance touchpoints.
                </p>
              </div>
              <div className="grid gap-3 text-sm">
                <div className="rounded-2xl border border-white/10 bg-black/40 p-4">
                  <p className="text-xs uppercase tracking-[0.3em] text-white/60">
                    Total Month Cost (Feb 2026)
                  </p>
                  <p
                ...
                <div className="rounded-2xl border border-white/10 bg-black/40 p-4">
                  ...
                  <p className="mt-2 text-sm text-white/80">
                    No incremental licensing or incorporation costs. All spend is
                    within pre-planned recurring or performance-linked envelopes.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="grid gap-8 lg:grid-cols-[1.2fr,1.1fr]">
            ...
            >
              ...
              <p className="text-xs text-white/60 mb-6">
                Animated month-level allocation of February burn across operating
                categories.
              </p>
                ...
                <div className="flex-1 space-y-2 text-xs sm:text-sm">
                  ...
                  {hoveredIndex !== null && (
                    <div className="mt-3 rounded-2xl border border-white/15 bg-black/60 p-3 text-[11px] sm:text-xs text-white/80">
                      ...
                      <p>{FEB_CATEGORIES[hoveredIndex].description}</p>
                    </div>
                  )}
                </div>
              </div>
          ...
          >
            <h2
              ...
              style={{ fontFamily: "var(--font-benzin)" }}
            >
              February Cost Curve by Category
            </h2>
            <p className="text-xs text-white/60 mb-6">
              Professional line visualization of how February spend builds up across
            ...
            <div className="w-full max-w-3xl mx-auto">
              <div className="relative h-64 w-full">
                ...
                {lineHoverIndex !== null && (
                  ...
                  >
                    <p
                      ...
                      style={{ fontFamily: "var(--font-benzin)" }}
                    >
                      {FEB_CATEGORIES[lineHoverIndex].name}
                    </p>
                    <p className="mb-1">
                      {formatInr(FEB_CATEGORIES[lineHoverIndex].inr)} ·{" "}
                      {formatUsd(FEB_CATEGORIES[lineHoverIndex].usd)}
                    </p>
                    <p className="text-white/70">
                      {FEB_CATEGORIES[lineHoverIndex].description}
                    </p>
                  </div>
                )}
                ...
                <svg viewBox="0 0 320 180" className="h-full w-full">
                  ...
                  {(() => {
                    const max = totalInr;
                    const step = (310 - 32) / (FEB_CATEGORIES.length - 1 || 1);
                    const points = FEB_CATEGORIES.map((cat, idx) => {
                      const x = 32 + step * idx;
                    ...
                    return (
                      <>
                        ...
                        {points.map((p, idx) => (
                          <motion.circle
                            key={FEB_CATEGORIES[idx].name}
                            cx={p.x}
                            cy={p.y}
                            r={4}
                            fill={FEB_CATEGORIES[idx].color}
                            stroke="#0F172A"
                            strokeWidth={1}
              ...
              <div className="mt-4 flex flex-wrap justify-between gap-4 text-[10px] sm:text-xs text-white/60">
                <p>
                  Left side of the curve reflects foundational costs (technology,
                  infrastructure, devices), while the mid-to-right segments show
                  growth and visibility levers (content, marketing, HR, reserve).
                </p>
                <p>
                  February burn remains fully within the planned structure: no
                  licensing shocks, no discretionary spikes—only recurring operating
                  commitments.
                </p>
              </div>
            </div>
          ...
          >
            <h2
              ...
              style={{ fontFamily: "var(--font-benzin)" }}
            >
              Category-by-Category View — February 2026
            </h2>
                  ...
                  {category.name === "Marketing & Ads" && (
                    <div className="rounded-xl border border-blue-400/30 bg-blue-400/10 p-3">
                      <p className="text-[10px] text-blue-200 mb-2">
                        <span className="font-semibold">Change vs January:</span>{" "}
                        ₹50,000 reduction
                      </p>
                      {category.decreaseReasoning && (
                        <div className="mt-2 pt-2 border-t border-blue-400/20">
                          <p className="text-[10px] text-blue-200/90 mb-1 font-semibold">
                            Strategic Reduction Reasoning:
                          </p>
            ...
            <div className="mt-6 rounded-2xl border border-blue-400/30 bg-blue-400/10 p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/70">
                    Variable | Not fixed. February may include selective client meetings
                    or professional engagements. Costs are incurred only when value-accretive
          ...
          <section className="grid gap-8 lg:grid-cols-[1.2fr,1.1fr]">
            ...
            >
              <h2
                ...
                style={{ fontFamily: "var(--font-benzin)" }}
              >
                February 2026 — Category-Wise Spend Table
              </h2>
                ...
                <table className="w-full text-xs sm:text-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="border-t border-white/10 text-white font-semibold">
                      <td className="px-4 py-2">Total (Feb 2026)</td>
                      <td className="px-4 py-2 text-right">
                        {formatInr(totalInr)}
                      </td>
                      <td className="px-4 py-2 text-right">
            ...
            >
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                February represents a disciplined operating month with predictable
                burn, stable execution, and no structural cost increases. Spend is
                focused on sustaining visibility, strengthening the pipeline, and
                maintaining operational efficiency while preserving runway.
              </p>
              <p className="mt-3 text-sm text-white/80 leading-relaxed">
                All categories remain within pre-agreed envelopes; marketing
                outlay is tracked against CAC performance, and content, software,
                and infrastructure spend directly support client acquisition,
                delivery quality, and governance. There are no discretionary or
                personal expenditures—only operating costs tied to execution and
                growth.
              </p>
            </motion.div>
          </section>
